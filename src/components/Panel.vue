...
export default {
	...
	methods: {
		parseWebTheme() {
			let	app = this.app || this.$route.params && this.$route.params.app ? this.$route.params.app : '';
			let theme = this.theme || this.$route.params && this.$route.params.theme ? this.$route.params.theme : '';
